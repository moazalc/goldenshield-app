...
export default function Contact() {
  const contactMethods = [
    {
      ...
      contact: "info@Goldenshield-uae.com",
    },
    {
      icon: (
        <svg
  ...
  return (
    <main className="py-14 bg-black">
      <div className="max-w-screen-xl mx-auto px-4 text-white md:px-8">
        <div className="max-w-lg mx-auto gap-12 justify-between lg:flex lg:max-w-none">
          <div className="max-w-lg space-y-3">
            <h3 className="text-yellow-500 text-5xl font-semibold">Contact</h3>
            ...
            <form onSubmit={(e) => e.preventDefault()} className="space-y-5">
              <div>
                ...
                <input
                  type="text"
                  required
                  className="w-full mt-2 px-3 py-2 text-black bg-white outline-none border focus:border-yellow-500 shadow-sm rounded-lg"
                />
              </div>
              <div>
